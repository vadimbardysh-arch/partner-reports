"""
Generate a multi-store weekly HTML report for Сімейна Піца / Сімейна Пекарня.
Produces simeyna-pizza/index.html with Smart Promo & Sponsored Listings sections.
"""
...
SIMEYNA_PIZZA_PROVIDERS = {
    170315: {"name": "Сімейна Піца вул. Чорновола 69", "short": "Чорновола 69", "city": "Lviv", "brand": "Сімейна Піца"},
    178055: {"name": "Сімейна Піца вул. Чорновола 57", "short": "Чорновола 57", "city": "Lviv", "brand": "Сімейна Піца"},
    170248: {"name": "Сімейна Піца вул. Городоцька 135", "short": "Городоцька", "city": "Lviv", "brand": "Сімейна Піца"},
    168775: {"name": "Сімейна Піца вул. Широка 65б", "short": "Широка 65б", "city": "Lviv", "brand": "Сімейна Піца"},
    170261: {"name": "Сімейна Піца вул. Широка 70б", "short": "Широка 70б", "city": "Lviv", "brand": "Сімейна Піца"},
    170273: {"name": "Сімейна Піца вул. Івана Пулюя", "short": "Пулюя", "city": "Lviv", "brand": "Сімейна Піца"},
    174858: {"name": "Сімейна Піца вул. Патона", "short": "Патона", "city": "Lviv", "brand": "Сімейна Піца"},
    174859: {"name": "Сімейна Піца вул. Сихівська", "short": "Сихівська", "city": "Lviv", "brand": "Сімейна Піца"},
    180428: {"name": "Сімейна Піца вул. Руставелі", "short": "Руставелі", "city": "Lviv", "brand": "Сімейна Піца"},
    184847: {"name": "Сімейна Піца вул. Вашингтона", "short": "Вашингтона", "city": "Lviv", "brand": "Сімейна Піца"},
    185883: {"name": "Сімейна Піца вул. Личаківська", "short": "Личаківська", "city": "Lviv", "brand": "Сімейна Піца"},
    176728: {"name": "Сімейна Піца вул. Червонія", "short": "Червонія", "city": "Rivne", "brand": "Сімейна Піца"},
    170320: {"name": "Сімейна Піца вул. Незалежності", "short": "Незалежності", "city": "Kovel", "brand": "Сімейна Піца"},
    170260: {"name": "Сімейна Піца вул. Орлика", "short": "Орлика", "city": "Drohobych", "brand": "Сімейна Піца"},
}

PROVIDER_IDS = ",".join(str(k) for k in SIMEYNA_PIZZA_PROVIDERS)

CITY_UA = {"Lviv": "Львів", "Rivne": "Рівне", "Kovel": "Ковель", "Drohobych": "Дрогобич"}
...
def build_data(weekly_df, ops_df, items_df, orders_df, complaints_df,
    ...
    for _, r in campaigns_df.iterrows():
        ...
        campaigns.append({
            ...
            "provider_id": pid,
            "provider_short": SIMEYNA_PIZZA_PROVIDERS.get(pid, {}).get("short", str(pid)),
...
<title>СІМЕЙНА ПІЦА | тижневий звіт</title>
...
<header class="header">
  <div class="header-left">
    ...
    <h1>СІМЕЙНА ПІЦА | тижневий звіт</h1>
  </div>
...
window.toggleDark = function() {{
  ...
  try {{ localStorage.setItem('simeyna-pizza-dark', isDark ? '1' : '0') }} catch(e) {{}}
  Chart.defaults.color = isDark ? '#D1D5DB' : '#374151';
  renderAll();
}};
(function() {{ try {{ if (localStorage.getItem('simeyna-pizza-dark') === '1') {{ document.body.classList.add('dark'); document.getElementById('theme-toggle').textContent = '☀️'; Chart.defaults.color = '#D1D5DB'; }} }} catch(e) {{}} }})();
...
def main():
    ...
    print(f"Starting Сімейна Піца report generation at {generated_at}")
